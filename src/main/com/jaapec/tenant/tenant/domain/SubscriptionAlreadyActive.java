...
public final class SubscriptionAlreadyActive extends DomainError {

	private static final String ERROR_CODE = "E426";
	private static final String MESSAGE_KEY = "error.subscription.already.active";

	public SubscriptionAlreadyActive() {
